...
export const CATEGORY_ORDER = [
  "Organización", "Finca", "Catering", "Foto", "Vídeo", "Música",
  "Vestuario", "Decoración", "Papelería", "Invitados", "Transporte", "Belleza",
];

export const STAGE_ORDER = [
  "+12 meses", "9-12 meses", "6-8 meses", "3-5 meses", "1-2 meses", "Última semana",
];
